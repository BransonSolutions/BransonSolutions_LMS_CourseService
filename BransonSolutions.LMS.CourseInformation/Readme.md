...
Execute unit tests
```
    cd "BransonSolutions.LMS.CourseInformation/test/BransonSolutions.LMS.CourseInformation.Tests"
    dotnet test
```

Deploy application
```
    cd "BransonSolutions.LMS.CourseInformation/src/BransonSolutions.LMS.CourseInformation"
